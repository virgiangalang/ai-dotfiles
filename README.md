...
[![Claude Code](https://img.shields.io/badge/Claude%20Code-✓%20Ready-blueviolet?style=for-the-badge&logo=anthropic&logoColor=white)](https://claude.ai/code)
[![Cursor](https://img.shields.io/badge/Cursor-✓%20Ready-00BFFF?style=for-the-badge&logo=cursor&logoColor=white)](https://cursor.sh)
[![Windsurf](https://img.shields.io/badge/Windsurf-✓%20Ready-00C896?style=for-the-badge)](https://codeium.com/windsurf)
[![Codex](https://img.shields.io/badge/OpenAI%20Codex-✓%20Ready-412991?style=for-the-badge&logo=openai&logoColor=white)](https://openai.com)
...
- Auto code review every time you write a new component
...
<details>
<summary><b>📱 Mobile Development (React Native, Flutter, Swift, Kotlin)</b></summary>
<br/>

- Set up Expo + React Native from zero to EAS build
- Flutter/Dart code review with idiomatic best practices
...
<details>
<summary><b>🔧 Backend & API (Go, Python, Rust, Node.js, FastAPI, Django)</b></summary>
<br/>

- Language-specific idiomatic code review (Go, Rust, Python, Java, C#)
- Database query optimization and schema design
- API design with proper error handling and rate limiting
...
<details>
<summary><b>🤖 AI & Agent Development</b></summary>
<br/>

- Build Claude Code plugins from scratch
- Multi-agent orchestration with SPARC methodology
- Autonomous agent loops
- Cross-session RAG memory with vector search
...
├── 📁 claudemem-skills/      # 17 Claude-Mem skills
├── 📁 anthropic-skills/      # 10 Anthropic official skills
│
...
├── 📖 GUIDE.md               # Full skill, agent & use-case guide
└── 📖 README.md              # This file
```
...
[![GitHub](https://img.shields.io/badge/github-virgiangalang-181717?style=flat-square&logo=github)](https://github.com/virgiangalang)
